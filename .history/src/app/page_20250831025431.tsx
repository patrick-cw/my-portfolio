                ...
                <CarouselContent>
                  {articles.map((article) => (
                    <CarouselItem key={article.title} className="md:basis-1/2">
                      <div className="p-1 h-full">
                        <article className="group flex h-full max-w-xl flex-col items-start justify-between rounded-lg bg-card-highlight p-6 transition-all duration-300 hover:-translate-y-2">
