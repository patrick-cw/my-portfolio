        ...
        <div className="container">
          ...
          <div className="mt-16">
            ...
            >
              ...
              <CarouselPrevious className="ml-12 h-16 w-16 bg-accent hover:bg-primary" variant="default" />
              <CarouselNext className="mr-12 h-16 w-16 bg-accent hover:bg-primary" variant="default" />
            </Carousel>
          </div>
        </div>
    </section>
