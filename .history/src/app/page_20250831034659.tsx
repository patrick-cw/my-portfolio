                ...
                {projects.map((project) => (
                  <CarouselItem key={project.title} className="md:basis-1/2 lg:basis-1/3">
                    <div className="p-1 h-full">
                       <div className="group flex flex-col h-full overflow-hidden rounded-lg bg-card-highlight shadow-lg transition-all duration-300 hover:shadow-muted/20 hover:-translate-y-2 hover:bg-accent">
