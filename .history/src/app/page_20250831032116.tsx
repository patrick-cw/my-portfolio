        ...
        <div className="container">
          ...
          <div className="mt-16">
            ...
            >
              ...
              <CarouselPrevious className="ml-12 h-10 w-10 bg-card-highlight hover:bg-primary" />
              <CarouselNext className="mr-12 h-10 w-10 bg-card-highlight hover:bg-primary"/>
            </Carousel>
          </div>
        </div>
    </section>
