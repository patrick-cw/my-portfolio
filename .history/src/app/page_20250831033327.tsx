                ...
                {projects.map((project) => (
                  <CarouselItem key={project.title} className="md:basis-1/2 lg:basis-1/3">
                    <div className="p-1 h-full">
                       <div className="group flex flex-col h-full overflow-hidden rounded-lg bg-card-highlight shadow-lg transition-all duration-300 hover:shadow-primary/20 hover:-translate-y-2 hover:bg-secondary">
                ...
                <CarouselContent>
                  {articles.map((article) => (
                    <CarouselItem key={article.title} className="md:basis-1/2">
                      <div className="p-1 h-full">
                        <article className="group flex h-full max-w-xl flex-col items-start justify-between rounded-lg bg-card-highlight p-6 transition-all duration-300 hover:bg-secondary hover:-translate-y-2">
