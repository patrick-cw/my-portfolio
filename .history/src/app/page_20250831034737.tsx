                          ...
                          <div className="flex flex-1 flex-col justify-between p-6">
                            <div className="flex-1">
                              <Link href={project.link} className="mt-2 block">
                                <p className="text-xl font-semibold text-foreground group-hover:text-muted transition-colors font-headline">{project.title}</p>
                            ...
                            <div className="mt-6 flex items-center">
                              <div className="flex space-x-1 text-sm text-muted-foreground">
                                {project.tags.map((tag) => (
                                  <span key={tag} className="inline-flex items-center rounded-full bg-muted px-3 py-1 text-xs font-medium text-accent-foreground">
                                    {tag}
                                  </span>
                                ))}
                              </div>
