      ...
      <div className="grid grid-cols-1 items-center gap-y-16 lg:grid-cols-2 lg:gap-x-2">
          ...
          <div className="flex justify-center lg:col-span-5 lg:col-start-8">
            <Image
              ...
              width={350}
              height={350}
              className="rounded-full object-cover shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-primary/20"
        ...
        <div className="container">
          ...
          <div className="mt-16">
            ...
            >
                ...
                {projects.map((project) => (
                  <CarouselItem key={project.title} className="md:basis-1/2 lg:basis-1/3">
                    <div className="p-1 h-full">
                       <div className="group flex flex-col h-full overflow-hidden rounded-lg bg-card-highlight shadow-lg transition-all duration-300 hover:shadow-primary/20 hover:-translate-y-2 hover:bg-accent">
                            ...
                            <div className="mt-6 flex items-center">
                              <div className="flex space-x-1 text-sm text-muted-foreground">
                                {project.tags.map((tag) => (
                                  <span key={tag} className="inline-flex items-center rounded-full bg-foregroudn px-3 py-1 text-xs font-medium text-secondary-foreground">
                                    {tag}
                                  </span>
                                ))}
                              </div>
              ...
              <CarouselPrevious className="ml-12 h-10 w-10 bg-accent hover:bg-primary" />
              <CarouselNext className="mr-12 h-10 w-10 bg-accent hover:bg-primary"/>
            </Carousel>
          </div>
        </div>
    </section>
                ...
                <CarouselContent>
                  {articles.map((article) => (
                    <CarouselItem key={article.title} className="md:basis-1/2">
                      <div className="p-1 h-full">
                        <article className="group flex h-full max-w-xl flex-col items-start justify-between rounded-lg bg-card-highlight p-6 transition-all duration-300 hover:bg-accent hover:-translate-y-2">
                 ...
                 <CarouselPrevious className="-left-12 h-10 w-10 bg-accent hover:bg-primary" />
                 <CarouselNext className="-right-12 h-10 w-10 bg-accent hover:bg-primary" />
              </Carousel>
            </div>
          </div>
      </section>
